...
<head>
    <title>Change Password - flicks</title>
    ...
    <header>
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
            <div class="container-fluid">
                <a class="navbar-brand" href="index.php">flicks</a>
    ...
    <div class="container">
        <div class="d-flex justify-content-center h-100">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="http://aknox07.lampt.eeecs.qub.ac.uk/flicks/admin/api.php?updatepassword">
                ...
                <div class="card-footer">
                    <div class="d-flex justify-content-center links">
                        Already Know your password?<a href="signin.php">Sign in</a>
                    </div>
                </div>
            </div>
        </div>
