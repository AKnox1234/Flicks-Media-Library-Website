...
$endpoint = "http://aknox07.lampt.eeecs.qub.ac.uk/flicks/admin/api.php?allshows";
...
<body>
    ...
    <main>
        <a href="view.php?id=3813">
            <img class="cropped1" src="https://news.newonnetflix.info/wp-content/uploads/2019/07/02_NF_TheWitcher_SocialSkin_facebook.jpg">
        </a>
        ...
        <div class="films py-3 rgb(15, 15, 15)">
            ...
            <div class="Container-fluid">
                <section class="py-2 container-fluid">
                    <h1 class="text-light" style="display:inline;">British TV</h1>
                    <span><a class="text-light float-right" style="position:relative; top:20px;" href="TV_Show_filter.php?gen=British">See more</a></span>
                </section>
            </div>
        ...
        <div class='container-fluid'>
          <div class='row row-cols-1 row-cols-sm-2 row-cols-md-5 g-1'>";
            ...
            ?>
                ...
                <div class="Container-fluid">
                  <section class="py-2 container-fluid">
                    <h1 class="text-light" style="display:inline;">TV Dramas</h1>
                    <span><a class="text-light float-right" style="position:relative; top:20px;" href="TV_Show_filter.php?gen=Dramas">See more</a></span>
                  </section>
                </div>
      ...
      <div class='carousel-item'>
        <div class='container-fluid'>
          ...
          ?>
                       ...
                       <div class="Container-fluid">
                        <section class="py-2 container-fluid">
                          <h1 class="text-light" style="display:inline;">Reality TV</h1>
                          <span><a class="text-light float-right" style="position:relative; top:20px;" href="TV_Show_filter.php?gen=Reality">See more</a></span>
                        </section>
                      </div>
    ...
    ?>
                            ...
                            <div class="Container-fluid">
                        <section class="py-2 container-fluid">
                          <h1 class="text-light" style="display:inline;">Docuseries</h1>
                          <span><a class="text-light float-right" style="position:relative; top:20px;" href="TV_Show_filter.php?gen=Docuseries">See more</a></span>
                        </section>
                      </div>
