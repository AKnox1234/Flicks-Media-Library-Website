...
$id = $_SESSION['flicks_subscriber'];

    $endpoint = "http://aknox07.lampt.eeecs.qub.ac.uk/flicks/admin/api.php?mylist=$id";
...
<body>
    ...
    <main>
        ...
        <div class="films py-5  rgb(15, 15, 15)">
            <div class="container-fluid">
